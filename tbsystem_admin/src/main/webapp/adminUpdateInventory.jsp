...
会員ID：${inventory.userIDSeller}<br>
出品価格：<input type="text" name="price" value="${inventory.price}"><br>
...
<br>
コメント：<textarea name="note" value="${inventory.note}""></textarea><br>
<input type="submit" value="更新"> 
<input type="hidden" name="action" value="updateInventoryConfirm"> 
