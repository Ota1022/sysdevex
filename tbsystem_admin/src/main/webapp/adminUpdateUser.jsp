...
<jsp:include page="/adminHeader.jsp" />
	...
	<form action="/tbsystem_admin/AdminSearchUserServlet" method="Post">
		...
		氏名：<input type="text" name="name" value=${user.name} required> <br> 
		住所：<input type="text" name="address" value=${user.address} required> <br> 
		電話番号： <input type="text" name="tel1" required>
		- <input type="text"name="tel2" required>
		- <input type="text" name="tel3"required> <br> 
		大学メールアドレス： <input type="text"name="email" value=${user.email} required> <br> 
		<input type="hidden"name="action" value="userConfirm"> <input type="submit"value="更新">
	</form>
	<form action="/tbsystem_admin/AdminSearchUserServlet" method="Post">
