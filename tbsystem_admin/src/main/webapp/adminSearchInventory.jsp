...
<input type="hidden" name="action" value="returnSearchInventory">
<input type="submit" value="検索"> 
</form>
<br>

<table border="1">
	<tr><th>ID</th><th>タイトル</th><th>出品者会員名</th><th>会員ID</th><th>出品価格</th>
	<th>在庫</th><th>状態</th>
	<th>コメント</th><th>更新</th><th>出品停止</th>
	</tr>
	...
	<tr>
		...
		<form action="/tbsystem_admin/AdminSearchInventoryServlet" method="get">
					...
					<input type="hidden" name="inventory_id" value="${invent.inventoryID}">
