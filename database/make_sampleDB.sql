...
INSERT INTO category(category_code, category_name) VALUES(3, '?��Љ�w?��?��?��n');
INSERT INTO category(category_code, category_name) VALUES(4, '?��o?��ϊw?��?��?��n');
...
INSERT INTO state(state_code, state_name) VALUES(1, '?��?��?��g?��p?��ɋ߂�');
INSERT INTO state(state_code, state_name) VALUES(2, '?��ڗ�?��?��?��?��?��?��?��≘�?��Ȃ�');
INSERT INTO state(state_code, state_name) VALUES(3, '?��?��⏝�≘��??��?��');
INSERT INTO state(state_code, state_name) VALUES(4, '?��?��?��≘��??��?��');
INSERT INTO state(state_code, state_name) VALUES(5, '?��S?��̓I?��ɏ�Ԃ�?��?��?��?��');
...
/*user table*/
/*admin*/
/*regist_date, delete_date, birthday?��͓�?��?��ĂȂ�*/
...
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user3', 'user3@test.ac.jp', 'himitu', '?��?��?��{?��?��?��s', '06-2222-2222', '2023-08-01', '2001-02-02');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user4', 'user4@test.ac.jp', 'himitu', '?��?��?��?��?��?��?��?��?��?��?��s', '092-3333-3333', '2023-08-02', '2002-03-03');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user5', 'user5@test.ac.jp', 'himitu', '?��k?��C?��?��?��D?��y?��s', '011-4444-4444', '2023-08-03', '2003-04-04');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user6', 'user6@test.ac.jp', 'himitu', '?��?��?��m?��?��?��?��?��É�?��s', '052-5555-5555', '2023-08-04', '2004-05-05');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user7', 'user7@test.ac.jp', 'himitu', '?��_?��ސ쌧?��?��?��l?��s', '045-6666-6666', '2023-08-05', '2005-06-06');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user8', 'user8@test.ac.jp', 'himitu', '?��L?��?��?��?��?��L?��?��?��s', '082-7777-7777', '2023-08-06', '2006-07-07');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user9', 'user9@test.ac.jp', 'himitu', '?��?��?��s?��{?��?��?��s?��s', '075-8888-8888', '2023-08-07', '2007-08-08');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user10', 'user10@test.ac.jp', 'himitu', '?��?��?��Ɍ�?��_?��ˎs', '078-9999-9999', '2023-08-08', '2008-09-09');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user11', 'user11@test.ac.jp', 'himitu', '?��{?��錧?��?��?��s', '022-1010-1010', '2023-08-09', '2009-10-10');
INSERT INTO user_table(name, email, password, address, tel, regist_date, birthday) VALUES('user12', 'user12@test.ac.jp', 'himitu', '?��É�?��?��?��É�?��s', '054-1111-1111', '2023-08-10', '2010-11-11');
