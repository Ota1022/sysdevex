	...
	<div style="text-align: center">
		...
		<div class="left">
			...
			<form action="/tbsystem_user/DisplayHistoryServlet" method="post">
				...
				<p>
					値段：<input type="text" name="price" required>円
				</p>
			</form>
			<p>
				コメント：
				<textarea name="note" rows="5" cols="33" style="vertical-align:top"></textarea>
			</p>
		</div>
				...
				<td>
					<form action="/tbsystem_user/DisplayHistoryServlet" method="post">
						<input type="hidden" name="inventory_id"
							...
							value="更新" class="example2"> <input type="hidden"
							name="action" value="updateItemConfirm">
					</form>
				</td>
				<td>
					<form action="/tbsystem_user/DisplayHistoryServlet" method="post">
						<input type="submit" value="戻る" class="example2"> <input
							type="hidden" name="action" value="displayHistory">
					</form>
				</td>
			</table>
		</div>
